            ...
            <View style={styles.petViewParentView}>
              <View style={styles.flexZero}>
                <Image
                  ...
                  source={{
                    uri: isEmergency ? item.pet_image_url : item.pet_image,
                  }}
                />
                <Text style={styles.missingStatusTextStyle}>
                  {item.pet_vermisst}
                </Text>
              </View>
                  ...
                  <TouchableWithoutFeedback
                    ...
                    <View style={styles.editDeleteParentView}>
                      <View style={styles.editDeleteChildView}>
                        <Pressable onPress={() => onHandSwipeIconPress(index)}>
                          <View
                            style={[
                              styles.flexZero,
