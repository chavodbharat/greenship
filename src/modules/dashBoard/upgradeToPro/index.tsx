      ...
      <SafeAreaView
        ...
        <ScrollView style={styles.scrollViewStyle}>
          ...
          <Text style={styles.value1}>
            All the subscriptions renew automatically for your convenience and
            to avoid any interruption of service.Your subscriptions can be
            managed by going to {Platform.OS === 'ios' ? 'itunes' : 'playstore'}{' '}
            account.
          </Text>
