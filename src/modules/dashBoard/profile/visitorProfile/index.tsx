      ...
      objValue && (
        <View style={styles.flexDirectionRowView}>
          <View style={styles.flexOne}>
            <Text style={[styles.tabLabelStyle, {marginTop: 0}]}>
              {objData.name}
            </Text>
          </View>
                      ...
                      childrean={
                        <View
                          ...
                          {state.memberObj?.member_types?.length > 0 && (
                            <Text style={styles.petPassportLabel}>
                  ...
                  <Pressable
                    style={[
                      styles.btnStyle,
                      {
                        marginRight: scale(10),
                        backgroundColor:
                          state.memberObj?.friendship_status_slug ===
                          'is_friend'
                            ? colors.communityGreenColor
                            : colors.lightGreen,
                      },
                    ]}
                    onPress={() =>
                      state.memberObj?.friendship_status_slug === 'is_friend' &&
