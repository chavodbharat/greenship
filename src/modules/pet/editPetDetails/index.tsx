...
const EditPetDetails = ({route}: any) => {
    ...
    dispatch(
      getIdentificationOfAnimal({form_id: formId}, (res: any) => {
        if (res) {
          ...
          setState(prev => ({
            ...prev,
            alphanumerischerCode: data['data-alphanumerischer'],
            dateOfImplantation: data['data-datum-der']
              ? data['data-datum-der']
              : staticDateOfImplantation,
            implantSite: data['data-implantierungsstelle'],
            alphanumericTattooCode: data['data-alphanumerischer-t'],
            dateOfTattoo: data['data-datum-der-ta']
              ? data['data-datum-der-ta']
              : staticDateOfTatto,
        ...
        getPetDetails({petId: petId}, (res: any) => {
          if (res) {
            ...
            setState(prev => ({
              ...
              petColors: data.pet_color,
              selectedFamilyTree: data.pet_stammbaum,
  ...
  const onContinuePress = () => {
    ...
    if (
      ...
      try {
        Promise.all([
          createNewPet(),
          uploadPetProfileImage(imageResponse),
  ...
  const uploadPetProfileImage = (imageResponse: any) =>
    new Promise(function (resolve, reject) {
      if (imageResponse && !imageResponse.isEditMode) {
        const formData = new FormData();
        formData.append('pet_profile', {
          name: imageResponse.path.substring(
            imageResponse.path.lastIndexOf('/') + 1,
          ),
          type: imageResponse.mime,
          uri:
            Platform.OS === 'ios'
              ? imageResponse.path.replace('file://', '')
              : imageResponse.path,
        });
  ...
  return (
    <View style={{flex: 1, backgroundColor: colors.listBackGradientThree}}>
      <SafeAreaView
        ...
        />
        <View style={[styles.flexZero, {backgroundColor: 'white'}]}>
          <ScrollView
            ...
            <View style={[styles.flexOne, {padding: scale(25)}]}>
              ...
              <TextInput
                ...
                onChangeText={size =>
                  setState(prev => ({...prev, petSize: size}))
                }
              />
              <TextInput
                mode="outlined"
              ...
              {state.alphanumerischerCodeError ? (
                <Text style={styles.error}>
                  Please enter alphanumerischer transponder-code
                </Text>
              ) : null}
              ...
              {state.alphanumericTattooCodeError ? (
                <Text style={styles.error}>
                  Please enter alphanumeric tattoo code
                </Text>
              ) : null}
              ...
              {state.nameOfAuthorizedVeterinarianError ? (
                <Text style={styles.error}>
                  Please enter name of authorized veterinarian
                </Text>
              ) : null}
                  ...
                  <View style={styles.flexOne}>
                    <Text
                      style={[
                        ...
                        state.dateOfIssue != staticDateOfIssue && {
              ...
              <TextInput
                ...
                style={[
                  ...
                  isViewOnly && {marginBottom: verticalScale(50)},
                ]}
